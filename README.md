...
*   **Typography:**
    *   `Serif` (*Playfair Display*): Used for headings and branding elements to achieve an editorial feel.
    *   `Sans` (*Inter*): Used for highly readable body copy, forms, and metadata.
